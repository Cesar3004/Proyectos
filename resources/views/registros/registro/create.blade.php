...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h3>Nuevo Ingreso de Articulos</h3>
        @if (count($errors)>0)
        ...
        {!!Form::open(array('url'=>'registros/registro','method'=>'POST','autocomplete'=>'off'))!!}
        {{Form::token()}}
<div class="row">
    ...
    <div class="col-lg-6-sm-6 col-md-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="numero_comprobante" required value="{{old('numero_comprobante')}}" class="form-control" placeholder="Numero de Comprobante"></input>
        </div>
    </div>
</div>
<div class="row">
